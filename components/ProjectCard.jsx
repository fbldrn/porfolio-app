  ...
  return (
    <Card className='group'>
        <CardHeader className='p-0'>
            <div className='relative w-full h-[300px] flex items-center justify-center bg-accent dark:bg-accent'>
        ...
        <div className='h-full px-8 py-6'>
            <Badge className='uppercase text-sm font-medium mb-2 relative -top-[310px] -left-2'>{project.category}</Badge>
